...
const eventos:event[] = [
    {
        ...
        fechas:[new Date("05/12/2023").toLocaleString('ex-mx').split(",")[0], new Date("10/12/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("08/20/2023").toLocaleString('ex-mx').split(",")[0], new Date("08/21/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("07/03/2023").toLocaleString('ex-mx').split(",")[0], new Date("07/10/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("06/12/2023").toLocaleString('ex-mx').split(",")[0], new Date("06/22/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("02/02/2023").toLocaleString('ex-mx').split(",")[0], new Date("02/20/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("03/21/2023").toLocaleString('ex-mx').split(",")[0], new Date("03/21/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("08/18/2023").toLocaleString('ex-mx').split(",")[0], new Date("08/20/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("10/10/2023").toLocaleString('ex-mx').split(",")[0], new Date("10/15/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("01/20/2023").toLocaleString('ex-mx').split(",")[0], new Date("01/26/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("06/17/2023").toLocaleString('ex-mx').split(",")[0], new Date("07/7/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("11/17/2023").toLocaleString('ex-mx').split(",")[0], new Date("20/17/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("02/12/2023").toLocaleString('ex-mx').split(",")[0], new Date("02/18/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("10/15/2023").toLocaleString('ex-mx').split(",")[0], new Date("10/18/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("08/02/2023").toLocaleString('ex-mx').split(",")[0], new Date("08/07/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("04/04/2023").toLocaleString('ex-mx').split(",")[0], new Date("04/24/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("11/01/2023").toLocaleString('ex-mx').split(",")[0], new Date("11/01/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("01/06/2023").toLocaleString('ex-mx').split(",")[0], new Date("01/06/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("03/18/2023").toLocaleString('ex-mx').split(",")[0], new Date("03/22/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("12/12/2023").toLocaleString('ex-mx').split(",")[0], new Date("12/12/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("04/02/2023").toLocaleString('ex-mx').split(",")[0], new Date("04/08/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("11/20/2023").toLocaleString('ex-mx').split(",")[0], new Date("12/25/2023").toLocaleString('ex-mx').split(",")[0]],
    ...
    },
    {
        ...
        fechas:[new Date("06/15/2023").toLocaleString('ex-mx').split(",")[0], new Date("07/01/2023").toLocaleString('ex-mx').split(",")[0]],
